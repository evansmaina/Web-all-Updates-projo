...
const navuu=document.querySelector('.navuu');
navuu.addEventListener('click',function(e){
    const navsyy=document.querySelectorAll('.current')
    navsyy.forEach(function(nav){
        nav.className=nav.className.replace('current','');
    })
